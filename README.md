...
You can install the released version of foofactorshlw from
[CRAN](https://CRAN.R-project.org) with:

``` r
install.packages("foofactorshlw")
```
...
devtools::install_github("hwilliams10/foofactorshlw")
```
